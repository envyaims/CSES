// Author: envy
// Problem: Money Sums from CSES - CSES Problem Set
// URL: https://cses.fi/problemset/task/1745
// Limits: 1000 ms, 512 MB
// Attempted: 2021-09-01 21:33:41 EST
...
void doStuff(){
	...
	vector<int> nums(n);
	readarr(nums);
	vector<vector<int>> dp(n+1, vector<int>(n*1000+1,false));
	//dp[first i coins][value]
	dp[0][0] = true;
	for(int i = 0; i < n; i++){
